                ...
                <form method="POST" action="{{ route('root.account.profile') }}" class="m-form m-form--fit m-form--label-align-right" id="form-profile-update">
                    ...
                    <div class="m-portlet__body">
                       ...
                       <div class="form-group m-form__group row">
                        ...
                        <!-- Contact no. -->
                        <div class="form-group m-form__group row">
                            <label for="contact_number" class="col-lg-2 col-form-label">Contact number</label>
                            <div class="col-lg-7">
                               <div class="input-group m-input-group">
                                    <div class="input-group-prepend">
                                    ...
                                    <input type="text" name="contact_number" id="contact_number" class="form-control m-input"
                                        value="{{ old('contact_number') ?? $superuser->contact_number }}">
                                </div>
            ...
            var formValidationInit = function () {
                $("form[id=form-profile-update]").validate({
                    ...
                    invalidHandler: function(event, validator) {
                        ...
                        $('button[type=submit]').removeClass('m-loader');
                    },
                });
            }
            //. form validate
