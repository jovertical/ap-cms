...
@section('content')
    <div class="m-portlet">
        ...
        <form method="POST" action="{{ route(user_env().'.categories.store') }}" id="form_store_category" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed m-form--state">
            @csrf
    ...
    <script>
        var data = function () {
            ...
            var validator = function () {
            	var form = $("form[id=form_store_category]");
