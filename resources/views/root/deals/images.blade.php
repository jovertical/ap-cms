        ...
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">Select images for <em>{{ $deal->name }}</em></h3>
                </div>
            </div>
        </div>
        <!--/. Head-->
        ...
        <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed m-form--state">
            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        <div action="{{ route(user_env().'.deals.images.store', $deal) }}"
                            class="m-dropzone dropzone" id="form-deal-images">
                ...
                <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                    <div class="m-form__actions m-form__actions--solid">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <a href="{{ route(user_env().'.deals.index') }}" class="btn btn-secondary">Skip</a>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('scripts')
    <script>
        Dropzone.options.formDealImages = {
            method: 'POST',
            headers: {
            ...
            init: function() {
                ...
                dz.on('removedfile', function(file) {
                    ...
                    $.ajax({
                        type: 'DELETE',
                        url: '{{ route(user_env().'.deals.images.destroy', $deal) }}',
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                        data: {
                ...
                $.get('{{ route(user_env().'.deals.images.index', $deal) }}', function(data) {
