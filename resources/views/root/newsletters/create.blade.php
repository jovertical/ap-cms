        ...
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">Create newsletter</h3>
                </div>
            </div>
        </div>

        <form method="POST" action="{{ route(user_env('newsletters.store')) }}" id="form_store_newsletter" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed m-form--state"
                ...
                <div class="form-group m-form__group row {{ $errors->has('trigger') ? 'has-danger' : '' }}">
                    ...
                    <div class="col-lg-6">
                        <select name="trigger" id="trigger" class="form-control m-bootstrap-select">
                            ...
                            <option value="subscribed" {{ old('trigger') == 'subscribed' ? 'selected' : '' }}>
                                User subscribed
                            </option>

                            <option value="registered" {{ old('trigger') == 'registered' ? 'selected' : '' }}>
                                User registered
                            </option>

                            <option value="scheduled" {{ old('trigger') == 'scheduled' ? 'selected' : '' }}>
                                Scheduled
                            </option>
                        </select>
    ...
    <script>
        var data = function () {
            ...
            var validator = function () {
            	var form = $("form[id=form_store_newsletter]");
