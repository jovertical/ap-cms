        ...
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">Select images for <em>{{ $product->name }}</em></h3>
                </div>
            </div>
        </div>
        <!--/. Head-->
        ...
        <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed m-form--state">
            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        <div action="{{ route(user_env().'.products.images.store', $product) }}"
                            class="m-dropzone dropzone" id="form-product-images">
                ...
                <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                    <div class="m-form__actions m-form__actions--solid">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <a href="{{ route(user_env().'.products.index') }}" class="btn btn-secondary">Skip</a>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('scripts')
    <script>
        Dropzone.options.formProductImages = {
            method: 'POST',
            headers: {
            ...
            init: function() {
                ...
                dz.on('removedfile', function(file) {
                    ...
                    $.ajax({
                        type: 'DELETE',
                        url: '{{ route(user_env().'.products.images.destroy', $product) }}',
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                        data: {
                ...
                $.get('{{ route(user_env().'.products.images.index', $product) }}', function(data) {
