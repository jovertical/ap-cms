        ...
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">Create News</h3>
                </div>
            </div>
        </div>

        <form method="POST" action="{{ route(user_env('news.store')) }}" id="form_store_news" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed m-form--state">
            @csrf
	        ...
	        <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row {{ $errors->has('title') ? 'has-danger' : '' }}">
                    ...
                    <div class="col-lg-6">
                        ...
                        <span class="m-form__help">The title of the News.</span>
                    </div>
                </div>
                <!--/. Title -->
                    ...
                    <div class="m-form__actions m-form__actions--solid">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <a href="{{ route(user_env('news.index')) }}" class="btn btn-secondary">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        var data = function () {
            ...
            var validator = function () {
            	var form = $("form[id=form_store_news]");
