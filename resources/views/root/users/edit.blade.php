        ...
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">Edit distributor</h3>
                </div>
            </div>
        </div>

        <form method="POST" action="{{ route('root.users.update', $user) }}" id="form-user-update"
                        ...
                        <div class="input-group m-input-group">
                            ...
                            <input type="text" name="contact_number" id="contact_number" class="form-control m-input
                                {{ $errors->has('contact_number') ? 'form-control-danger' :'' }}"
                                    placeholder="Please enter contact number" value="{{ old('contact_number') ?? $user->contact_number }}">
                        </div>
