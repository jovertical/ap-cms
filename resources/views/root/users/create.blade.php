        ...
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">Create distributor</h3>
                </div>
            </div>
        </div>

        <form method="POST" action="{{ route(user_env().'.users.store') }}" id="form-user-store" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed m-form--state">
            {{ csrf_field() }}
            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row {{ $errors->has('contact_number') ? 'has-danger' : '' }}">
                    <label for="contact_number" class="col-lg-2 col-form-label">
                        Contact number
                    </label>
                    ...
                    <div class="col-lg-6">
                        <div class="input-group m-input-group">
                            ...
                            <input type="text" name="contact_number" id="contact_number" class="form-control m-input
                                {{ $errors->has('contact_number') ? 'form-control-danger' :'' }}"
                                    placeholder="Please enter contact number" value="{{ old('contact_number') }}">
                        </div>

                        @if ($errors->has('contact_number'))
                            <div id="contact_number-error" class="form-control-feedback">
                                <span class="m--font-danger">{{ $errors->first('contact_number') }}</span>
                            </div>
                        @endif
