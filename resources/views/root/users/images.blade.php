        ...
        <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed m-form--state">
            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        <div action="{{ route(user_env().'.users.images.store', $user) }}"
                            class="m-dropzone dropzone" id="form-user-images">
                ...
                <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                    <div class="m-form__actions m-form__actions--solid">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <a href="{{ route(user_env().'.users.index') }}" class="btn btn-secondary">Skip</a>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('scripts')
    <script>
        Dropzone.options.formUserImages = {
            method: 'POST',
            headers: {
            ...
            init: function() {
                ...
                dz.on('removedfile', function(file) {
                    ...
                    $.ajax({
                        type: 'DELETE',
                        url: '{{ route(user_env().'.users.images.destroy', $user) }}',
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                        data: {
                ...
                $.get('{{ route(user_env().'.users.images.index', $user) }}', function(data) {
