        ...
        <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed m-form--state">
            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        <div action="{{ route(user_env('superusers.images.store'), $superuser) }}"
                            class="m-dropzone dropzone" id="form-superuser-images">
                ...
                <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                    <div class="m-form__actions m-form__actions--solid">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <a href="{{ route(user_env('superusers.index')) }}" class="btn btn-secondary">Skip</a>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('scripts')
    <script>
        Dropzone.options.formSuperuserImages = {
            method: 'POST',
            headers: {
            ...
            init: function() {
                ...
                dz.on('removedfile', function(file) {
                    ...
                    $.ajax({
                        type: 'DELETE',
                        url: '{{ route('root.superusers.images.destroy', $superuser) }}',
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                        data: {
                ...
                $.get('{{ route('root.superusers.images.index', $superuser) }}', function(data) {
