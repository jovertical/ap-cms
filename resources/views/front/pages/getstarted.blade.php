                    ...
                    <div class="page-heading-inner">
                        <h1 class="page-title">
                            ...
                            <span>Join us now!</span>
                                                  ...
                                                  <br><i><center>
Now that you’ve made the decision to become an AuraRich Reseller or Distributor, please fill out the information below to secure your slot and pre-order discounts. </i></center>
<br><br><br>
                    </div>
                </div>
            </div>
...
<br><br><br>
                    <a href="{{route(user_env().'.howitworks')}}"><input type="button" class="btn" value="How it Works" /></a><br><br>
                  </div>
                </form>
              </div>
            </div>
