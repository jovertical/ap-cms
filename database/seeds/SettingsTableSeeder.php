...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
       $settings = [
            ...
            Our independent distributor program offers you the opportunity to be your own boss, build your own clients, acquire reward points for travel and annual bonuses, while making great money from your sales! We are currently recruiting TOP sales team members in preparation for our Philippine launch in Fall 2018. Sign up today to lock in your pre-order discounts and ensure your position at the top!

            All AuraRich products are FDA and ASEAN approved, and have not been tested on animals. We stand by our products and our top team members are also proud users of the product!'],
            ['key' => 'deals', 'value' => 'Now that you have made a decision to become na AuraRich Reseller or Distributor, You may now choose which deals suits you best. '],
